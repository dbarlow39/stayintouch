...
const AdGeneratorPanel = ({ listing, autoGenerate = false }: AdGeneratorPanelProps) => {
  ...
  // Use the OG edge function URL for Facebook link posts so Facebook scrapes dynamic meta tags
  const ogListingUrl = `https://listings.sellfor1percent.com/og-listing?id=${listing.id}`;
