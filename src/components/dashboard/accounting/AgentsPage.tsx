...
import { ArrowLeft, Plus, Pencil, Trash2, Save, X, List } from "lucide-react";
...
const AgentsPage = ({ onBack, onNavigate }: AgentsPageProps) => {
  const { user } = useAuth();
                ...
                <TableRow key={agent.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-1">
                      ...
                      <Button size="sm" variant="ghost" className="h-7 text-xs" onClick={() => onNavigate(`agent-closings:${agent.full_name}`)}>
