...
const TOOL = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      listing_agent_name: { type: "string", description: "Listing/seller agent full name. PRIORITIZE the value typed/written on the 'Seller's Agent:' line on page 1 of the closing package. ALSO check the Agency Disclosure Statement, 'Section I. TRANSACTION INVOLVING TWO AGENTS IN TWO DIFFERENT BROKERAGES' — the name written on the line 'The seller will be represented by ____' (labeled AGENT(S)) is the listing agent; the brokerage on that same line should match a Sell For One Percent / Sellfor1percent brokerage for our deals. Prefer this Section I value over signature blocks and 'Listing Brokerage' text when it is present. Also check 'Listing Brokerage', 'Listing Broker', and the agent line on the Settlement Statement." },
      buyer_agent_name: { type: "string", description: "Buyer/selling agent full name. PRIORITIZE the value typed/written on the 'Buyer's Agent:' line on page 1 of the closing package. ALSO check the Agency Disclosure Statement, 'Section I. TRANSACTION INVOLVING TWO AGENTS IN TWO DIFFERENT BROKERAGES' — the name written on the line 'The buyer will be represented by ____' (labeled AGENT(S)) is the buyer agent. Prefer this Section I value over signature blocks and 'Selling Brokerage' text when it is present. Also check 'Selling Brokerage', 'Cooperating Broker', and the agent line on the Settlement Statement. If multiple names are present (e.g. 'Shayne Boyd/Rhiannon Ferrari'), keep them joined as-is." },
      built_before_1978: {
        type: "boolean",
