...
serve(async (req) => {
  ...
  try {
    ...
    const scope = "pages_manage_posts,pages_read_engagement,pages_show_list,business_management,read_insights,ads_read,instagram_basic,instagram_content_publish";
